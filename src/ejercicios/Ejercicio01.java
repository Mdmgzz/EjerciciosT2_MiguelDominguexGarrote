	...
	public static void main(String[] args) {
		...
		// Declaramos las variables
				...
				if (numero < 0 || numero > 10000) {						//Si el numero es menor que 1 y mayor que 9999 no es valido
					...
					cifra2 =  (cifra1 / 100) % 10;							//Dividimos entre 100 y sacamos la parte entera y esa parte entera le hacemos el modulo de 10 y nos dará la segunda cifra
					cifra3 =  (cifra1 / 10) % 10; 							//Dividimos entre 10 y sacamos la parte entera y esa parte entera le hacemos el modulo de 10 y nos dará la tercera cifra
